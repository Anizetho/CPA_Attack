function [result] = aes_key_schedule(round_key_256, round)
    ...
    result(1)  = bitxor(bitxor(aes_sbox(w7(2)), w0(1)), rcon(round));
    result(2) = bitxor(aes_sbox(w7(3)), w0(2));
    result(3)= bitxor(aes_sbox(w7(4)), w0(3));
    result(4)= bitxor(aes_sbox(w7(1)), w0(4));

    result(5:8) = bitxor(result(1:4), w1);
    result(9:12) = bitxor(result(5:8), w2);
    result(13:16) = bitxor(result(9:12), w3);

    result(17) = bitxor(aes_sbox(result(13)), w4(1));
    result(18) = bitxor(aes_sbox(result(14)), w4(2));
    result(19) = bitxor(aes_sbox(result(15)), w4(3));
    result(20)  = bitxor(aes_sbox(result(16)), w4(4));
